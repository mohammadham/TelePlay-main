...
# ==================== VIDEO-ONLY NOTE ====================
# Music domain (Artist/Album/Track/Playlist etc) intentionally NOT in this branch.
# This branch is pure video (Netflix-like). See feature/music-platform for music.
...
class AdImpression(Base):
    ...
    movie_id: Mapped[Optional[int]] = mapped_column(ForeignKey("movies.id", ondelete="SET NULL"))
